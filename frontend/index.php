<?php
    require_once 'frontend/HelperFields.php';
?>
<!DOCTYPE html>
...
<head>
    ...
    <title>Digital-агентство WeCoders</title>
    ...
    <!-- animate-text css -->
    <link rel="stylesheet" href="/frontend/css/animate-text.css">
    <!-- magnific-popup css -->
    <link rel="stylesheet" href="/frontend/css/magnific-popup.css">
    <!-- et-line fonts css -->
    <link rel="stylesheet" href="/frontend/css/et-line.css">
                ...
                <div class="row">
                    ...
                    <div class="col-md-2 col-sm-3 col-xs-8">
                        <div class="logo ptb-22">
                            <a href="index.php">
                                <img src="<?= HelperFields::getGeneralData('logo') ?>" alt="main logo">
                            </a>
                        </div>
                    </div>
...
<?php
    $allSliderItems = HelperFields::getAllFieldData('main-slider');
?>
<!-- Слайдер -->
<section class="slider-area">
    <div class="slider-active">
        <?php foreach ($allSliderItems as $key => $slide): ?>
        <div class="single-slider">
            <div class="slider-img parallax-bg bg-opacity-black-60" style="background:url(<?= $slide['img'] ?>)"></div>
...
<section class="who-area-are pad-90" id="about_us">
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-5">
                <div class="about-bg">
                    <img src="/frontend/img/about/o_nas_text_block.jpg" alt=""/>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            ...
            <div id="Container">
                <div class="col-md-4 col-sm-6 col-xs-12 mb-30 mix landing promo">
                    <div class="portfolio-wrapper portfolio-title">
                        <div class="portfolio-img">
                            <img src="/frontend/img/portfolio/1.jpg" alt=""/>
                ...
                <div class="col-md-4 col-sm-6 col-xs-12 mb-30 mix internet_shop corporative_site">
                    <div class="portfolio-wrapper portfolio-title">
                        <div class="portfolio-img">
                            <img src="/frontend/img/portfolio/2.jpg" alt=""/>
                            <div class="work-text brand-bg">
                                <div class="inner-text">
                ...
                <div class="col-md-4 col-sm-6 col-xs-12 mb-30 mix landing">
                    <div class="portfolio-wrapper portfolio-title">
                        <div class="portfolio-img">
                            <img src="/frontend/img/portfolio/3.jpg" alt=""/>
                            <div class="work-text brand-bg">
                                <div class="inner-text">
                ...
                <div class="col-md-4 col-sm-6 col-xs-12 mb-30 mix internet_shop">
                    <div class="portfolio-wrapper portfolio-title">
                        <div class="portfolio-img">
                            <img src="/frontend/img/portfolio/4.jpg" alt=""/>
                            <div class="work-text brand-bg">
                                <div class="inner-text">
                ...
                <div class="col-md-4 col-sm-6 col-xs-12 mb-30 mix corporative_site">
                    <div class="portfolio-wrapper portfolio-title">
                        <div class="portfolio-img">
                            <img src="/frontend/img/portfolio/5.jpg" alt=""/>
                            <div class="work-text brand-bg">
                                <div class="inner-text">
                ...
                <div class="col-md-4 col-sm-6 col-xs-12 mb-30 mix promo">
                    <div class="portfolio-wrapper portfolio-title">
                        <div class="portfolio-img">
                            <img src="/frontend/img/portfolio/6.jpg" alt=""/>
                            <div class="work-text brand-bg">
                                <div class="inner-text">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12">
                    <div class="footer-widget footer-widget-center text-center">
                        ...
                        <div class="footer-logo">
                            <a href="#">
                                <img src="/frontend/img/logo/logo-white.png" alt=""/>
                            </a>
                        </div>
...
<!-- animate text js -->
<script src="/frontend/js/animate-text.js"></script>
<!-- plugins js -->
